...
class WantedView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<WantedProvider>(
      builder: (context, wantedProvider, child) {
        return PageView(
          controller: wantedProvider.wantController,
          physics: const ClampingScrollPhysics(),
          children: [
            LiveScreen(closePage: wantedProvider.closePage),
            WantedTab(
              onNavigateToLive: wantedProvider.goToLive,
              onOpenDrawer: wantedProvider.openDrawer,
            ),
            NavigationEndDrawer(closePage: wantedProvider.closePage),
          ],
        );
      },
    );
...
class NavigationEndDrawer extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final wantedProvider = Provider.of<WantedProvider>(context);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: wantedProvider.closePage, // ✅ Utilisation du Provider
        ),
      ),
      body: ListView(
        children: [
