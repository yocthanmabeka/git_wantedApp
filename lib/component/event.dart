      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  EventParticipationScreen(event: event, creator: creator),
            ),
          );
        },
...
// /// ✅ **EventCard - Instagram-like Event Display**
// /// This widget presents an **event card** similar to Instagram, with:
// /// - Media preview, title, and description
// /// - Actions (like, comment, share)
// /// - Participants section
// /// - A vertical line connecting the avatar to the "Participate" button
// class EventCard extends StatelessWidget {
//   final EventModel event;
//   final UserModel creator;
...
//                 height: 525, // Connects avatar to the participate button
//               ),
//               Expanded(
//                 child: Column(
//                   children: [
...
//           constraints: const BoxConstraints.expand(width: 320, height: 375),
//           decoration: BoxDecoration(
//             borderRadius: BorderRadius.circular(10),
//             image: mediaType == 'image'
//                 ? DecorationImage(
...
//         constraints: const BoxConstraints.expand(width: 320, height: 350),
//         color: Colors.grey[300],
//         child: const Center(child: Text('Aucun média disponible')),
//       );
//     }
...
//       child: Text(
//         event.title.isNotEmpty ? event.title : 'Sans titre',
...
//   /// ✅ **Displays the Event Main Action Button**
//   Widget _buildMainActionButton(BuildContext context) {
//     return Container(
...
//         mainAxisAlignment: MainAxisAlignment.spaceAround,
//         children: [
//           _buildIconButton(FontAwesomeIcons.heart, 2000),
//           _buildIconButton(FontAwesomeIcons.comment, 500),
//           _buildIconButton(FontAwesomeIcons.share, 300),
//         ],
//       ),
//     );
//   }
